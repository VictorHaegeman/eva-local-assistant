...
def _build_interpreter_prompt(
    ...
    return (
        ...
        "Policy learning locale:\n"
        f"- reinforcement={base_frame.reinforcement_summary or 'pas encore assez de donnees'}\n"
        f"- delta={base_frame.reinforcement_score}\n"
        f"- candidates={', '.join(base_frame.reinforcement_candidates) if base_frame.reinforcement_candidates else 'aucun'}\n\n"
        "Routes autorisees:\n"
